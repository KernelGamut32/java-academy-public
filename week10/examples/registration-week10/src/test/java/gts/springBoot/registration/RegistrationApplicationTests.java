...
//	@Test
//	public void testGetCourseById() {
//		Course course = new Course("CS105", "Software Engineering");
...
//
//		when(courseServiceMock.getCourse(course.getId())).thenReturn(course);
//
...
//		assertThat(updateResponse.getBody().getTitle()).isEqualTo("Advanced Algorithms");
//	}
