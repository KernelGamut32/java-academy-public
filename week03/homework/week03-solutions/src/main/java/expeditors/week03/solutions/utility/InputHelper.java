package expeditors.week03.solutions.utility;
...
public class InputHelper {
    public static String gatherInput(Scanner consoleInput, String prompt,
        ...
        do {
            ...
            inputValue = consoleInput.nextLine().trim();
    ...
    public static String gatherInput(Scanner consoleInput, String prompt,
                                     String errorMessage, String regex) {
        boolean inputIsValid;
        String inputValue;

        do {
            inputIsValid = true;
            inputValue = InputHelper.gatherInput(consoleInput, prompt, errorMessage);
